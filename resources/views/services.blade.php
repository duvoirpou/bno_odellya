        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-4">
                ...
                <div class="col" data-aos="zoom-in" data-aos-delay="100">
                    <h3 class="text-center">Offre Serenity : Création Email pro et sécurisés pour tous</h3>
                    <p>
                        Avec notre solution de création d'Email PRO sécurisé, il ne suffit pas seulement d'avoir une adresse Email. {{ config('app.name') }} vous offre bien plus qu'une création d'adresse mail, mais une offre de service complète axée autour de la sécurité de votre Email Pro, et un service de mailing-list.
                    </p>
                    <ul class="list-unstyled">
                        <li><i class="bi bi-check2"></i> <span>Une adresse Email adossée à votre nom de domaine</span></li>
                        <li><i class="bi bi-check2"></i> <span>Une méssagerie sous haute surveillance</span></li>
                        <li><i class="bi bi-check2"></i> <span>Utilisation du protocole IMAP</span></li>
                        <li><i class="bi bi-check2"></i> <span>Redirection Email</span></li>
                        <li><i class="bi bi-check2"></i> <span>Archivage Email</span></li>
                    </ul>
