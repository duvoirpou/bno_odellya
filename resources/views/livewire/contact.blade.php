<div>
    <form method="post" role="form" class="php-email-form">
        ...
        <div class="text-center" wire:loading.delay>Envoi en cours...</div>
        <div class="text-center" wire:loading.delay.remove>
            <button type="submit" wire:click.prevent='store()' wire:loading.attr='disabled'>Envoyez le Message</button>
        </div>
